...
var accordion = $.widget( "ui.accordion", {
	...
	_setOption: function(key, value) {
	    var isDisabled = (key === "disabled"),
            ...
            $panel;
	    var isEnabled = (key === "enabled"); // Check if we're disabling a specific accordion // section by index. 
	    if (isDisabled && isNumber) { 
	        ...
	        $panel.addClass("ui-state-disabled").next().filter(".ui-accordion-content-active").addClass("ui-state-disabled");
	    } else if (isEnabled && isNumber)
	    {
	        $panel = this._findActive(value); $panel.removeClass("ui-state-disabled").next().filter(".ui-accordion-content").removeClass("ui-state-disabled").addClass("ui-accordion-content-active");
	    } 
        else
	    {
	        this._super(key, value);
